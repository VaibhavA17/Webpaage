...
<head>
  ...
  <meta name="keywords" content="WebPaage Technologies,  Build your dream online website with us. Create a professional platform without any complicated struggle. We are delivering success with every solution. Contact us for Web Designing and Development, SEO or (Search Engine Optimisation), and Applications Development. and Support Indian Developers from Bareilly, Uttar Pradesh , India!!">
   
  <meta name="description" content="Web Designing and Development, SEO or (Search Engine Optimisation), and Applications Development. and Support Indian Developers from Bareilly, Uttar Pradesh , India!!">

  <meta name="copyright" content="WebPaage , https://www.WebPaage.in/">

  <title>WebPaage Technologies | Web Designing And Development | SEO (Search engine optimization) | Application Development Services in Bareilly </title>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-floating nav-dark">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      ...
      <div class="ml-auto my-2 my-lg-0">
        <a class="nav-link" href="contact.php"><button class="btn btn-dark rounded-pill">Contact NOW</button></a>
      </div>
    </div>
  </div>
</nav>
  ...
  <div class="hero-caption pt-5">
    <div class="container h-100">
      <div class="row align-items-center h-100">
        <div class="col-lg-6 wow fadeInUp" style="font-family: serif; ">
        	<br>
        	<br>
        	<br>
          <div class="badge mb-2"><span class="icon mr-1"><span class="mai-globe"></span></span> We Are Always Ready To Help You</div>
          <h1 class="mb-4">Grow Your Business Online With Us</h1>
          <p class="mb-4">When everything is online then why are'nt you? Take your buisness online and reach the people all over the world not just in Bareilly or UP.
Create your professional looking website design today. Or already have a website looking to take it one step ahead? We will develop your website with the look you imagined.
<br>

Just Contact Us!! Support local developers from Bareilly.
<br>
Take a tour of our website and browse through amazing web development plans today!
</p>
        </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="../assets/img/clients/p1.png" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="../assets/img/clients/p5.jpg" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="../assets/img/clients/akshat.jpg" alt="">
        </div>
      </div>
      <div class="col-sm-6 col-lg-3 py-3 wow zoomIn">
        <div class="img-place client-img">
          <img src="../assets/img/clients/p4.png" alt="">
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="iconic-list">
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              <h5>Best Web Hosting</h5>
              <p class="fs-small">A web hosting service is a type of Internet hosting service that allows individuals and organizations to make their website accessible via the World Wide Web</p>
            </div>
          </div>
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              <h5>Fully Secured</h5>
              <p class="fs-small">We can’t forget about the statistics, which make website security a compelling topic for any online business—regardless of their size.</p>
            </div>
          </div>
          <div class="iconic-item wow fadeInUp">
            ...
            <div class="iconic-content">
              ...
              <p class="fs-small">Monitoring is essential to ensure that a website is available to users</p>
            </div>
          </div>
        </div>
      </div>
...
<div class="page-section">
  <div class="container">
    <div class="row">
      <div class="col-lg-6 offset-lg-1 py-3 mt-lg-5 wow fadeInUp" style="font-family: serif;">
        <h1 class="mb-4">Ecommerce business opperate easilly</h1>
        <p class="mb-4">Why aren't your shop Website is not online yet?
In this hard times every commercial buisness took hit. And hit real hard! But some buisness were not at all at loss instead they made huge profit. Why? Because if you open your 
buisness in formal timings for someone to visit your store. It's asking too much at current scenerio.
Solution is begin your E-Commerce Buisness Now. Give round of clock time to your customers to reach you. Whenever they want, from wherever they are. 
It is a one-time investment to expand your buisness to huge amount of new customers. And doing this, support your buisness and local developers from Bareilly.
Look at our flexible plans today at WebPaage.in </p>
        <a href="updates.html" class="btn btn-outline-primary rounded-pill">Services</a>
      </div>
      <div class="col-lg-5 py-3">
        <div class="img-place mobile-preview shadow wow zoomIn">
  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-5 mb-5 mb-lg-0 wow fadeInUp">
        ...
        <p class="mb-5">The Good-Better-Best Approach to Pricing</p>
        ...
        <div class="pricing-table">
          <div class="pricing-item active wow zoomIn">
            <div class="pricing-header">
              <h5>Static Plan</h5>
              <br>
              <h1 class="fw-normal" style="font-size: 35px;">4999-9999/-</h1>
            </div>
            <div class="pricing-body">
              <ul class="theme-list">
                <li class="list-item">View Level </li>
          ...
          <div class="pricing-item wow zoomIn" data-wow-delay="200ms">
            <div class="pricing-header">
              <h5>Dynamic Plan</h5>
              <br>
              <h1 class="fw-normal" style="font-size: 35px;">14999-24999/-</h1>
            </div>
            <div class="pricing-body">
              <ul class="theme-list">
    ...
    <div class="row mb-5 py-3">
      ...
      <div class="col-sm-6 col-lg-2 py-3">
        ...
        <ul class="menu-link">
          ...
          <li><a href="contact.php" class="">Careers</a></li>
          <li><a href="contact.phps class="">HIRING!</a></li>
        </ul>
      </div>
